This is a simple GitHub repository for the Wheel of Fortune Next.js project. Next.js is a popular framework for building server-side rendered React applications.
